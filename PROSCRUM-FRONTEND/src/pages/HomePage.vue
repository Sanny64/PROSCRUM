...
<template>
  <div class="content">
    <calculation-input @formData="handleFormData" :course-list="apiResultCourse"></calculation-input>
    <calculation-output :polling-status="apiStatus"  :rounds-result="apiResultRounds"></calculation-output>
 </div>
</template>
